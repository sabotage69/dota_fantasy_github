...
export default function AppendWinnings(props) {
  ...
  function handleSubmit(event) {
    ...
    //console.log(props.eventNumber, props.winningsList, props.loopedOverChainsList, props.winnersList)
    //runContractFunction()
    updateUI();
    console.log(
  ...
  return (
    <>
      <div className="submit-winnings-card">
        <div className="close-match-card-title">Submit winnings</div>
        <button
